      ...
      <section className="landing-tentang" id="tentang">
        <div className="tentang-card">
          <div className="tentang-text">
            ...
            <p className="tentang-desc"> Dapur MUA hadir sebagai solusi bagi para Makeup Artist (MUA) untuk efisiensi dan efektivitas kerja terkait manajemen booking dan pengelolaan data.<br /><br />Ada pertanyaan, kendala, atau masukan?<br />Langsung aja hubungi lewat salah satu kontak berikut.</p>
          </div>
